...
describe('Miscellaneous - Failure', () => {
  for (const text of [
    ...
    '(a, ...b);',
    'var e = [a -= 12] = 5',
    String.raw`function l() { "\12"; "use strict" }`,
    String.raw`function l() { "\00002"; "use strict" }`,
    String.raw`function l() { "\712"; "use strict" }`,
    String.raw`function l() { "\12"; "use strict" }`,
    '[ a -= 12 ] = 12;',
    '(...a)',
    '(a, ...b)',
    ...
    String.raw`function f() { if (0) obj.foo\su03bb;  }`,
    ...
    // FIXME: #337, `await` spelled with a unicode escape is still accepted
    ...
    '"use strict";\n"\\07";',
    '"use strict";\n"\\011"',
    String.raw`"use strict"; "\08"`,
    String.raw`"use strict"; "\09"`,
    // 'await ~123',
    'async () => class await {}',
    '{_ => {}/123/g;}',
    '({a}) = 1;',
    ...
    String.raw`function hello() { 'use strict'; "\1"; }`,
    "function hello() { 'use strict'; ({ 021: 42 }); }",
    String.raw`function hello() { "use strict"; function inner() { "octal directive\1"; } }`,
    ...
    '/fo[^a]',
    String.raw`/fa[\b]oo`,
    String.raw`/(fo)\b\B\cA\d\D\f\n\r\s\S\t\v\w\W\1\0\xab\uabcd`,
    String.raw`/ab\1c`,
    String.raw`/ab\c`,
    String.raw`/ab\c2`,
    String.raw`/ab\c\d`,
