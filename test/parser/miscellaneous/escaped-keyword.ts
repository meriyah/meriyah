...
describe('Miscellaneous - Escaped keywords', () => {
  ...
  fail('Miscellaneous - Escaped identifiers (failures)', [
    ...
    { code: String.raw`var x = { interf\u0061ce } = { interface: 42 };`, options: { module: true } },
    ...
    { code: String.raw`export function br\u0065ak() {}`, options: { module: true } },
    { code: String.raw`class aw\u0061it {}`, options: { module: true } },
    ...
    { code: String.raw`aw\u0061it: 1;`, options: { module: true } },
    ...
    String.raw`({\u0067et get(){}})`,
    String.raw`({\u0073et set(){}})`,
    { code: String.raw`import* \u0061s foo from "./icefapper.js";`, options: { module: true } },
    { code: String.raw`void \u0061sync function* f(){};`, options: { module: true } },
    String.raw`a(1,2\u0063onst foo = 1;`,
    String.raw`\u0063o { } while(0)`,
    String.raw`cl\u0061ss Foo {}`,
    ...
    { code: String.raw`var x = { privat\u0065 } = { private: 42 };`, options: { module: true } },
    { code: String.raw`var x = { sup\u0065r } = { super: 42 };`, options: { module: true } },
    { code: String.raw`var x = { v\u0061r } = { var: 42 };`, options: { module: true } },
    { code: String.raw`var x = { privat\u0065 } = { private: 42 };`, options: { module: true } },
    ...
    String.raw`def\u0061ult`,
    { code: String.raw`var x = { \u0069mport } = { import: 42 };`, options: { module: true } },
    String.raw`(v\u006fid 0)`,
    { code: String.raw`aw\u0061it: 1;`, options: { module: true } },
    ...
    String.raw`i\u0066 (0)`,
    String.raw`var i\u0066`,
    { code: String.raw`export {a \u0061s b} from "";`, options: { module: true } },
    { code: String.raw`export {} fr\u006fm "";`, options: { module: true } },
    ...
    { code: String.raw`export \u0061sync function y() { await x }`, options: { module: true } },
    { code: String.raw`export default \u0061sync function () { await x }`, options: { module: true } },
    ...
    String.raw`\u{74}rue`,
    String.raw`var \u{64}\u{6f} = 123;`,
    { code: String.raw`var \u{64}\u{6f} = 123;`, options: { module: true } },
    { code: String.raw`a\u{0022}b=1`, options: { impliedStrict: true } },
    { code: String.raw`function impl\u0065ments() {}`, options: { impliedStrict: true } },
    { code: String.raw`function impl\u0065ments() {}`, options: { module: true } },
    { code: String.raw`var gen = function *() { void yi\u0065ld; };`, options: { module: true } },
    { code: String.raw`var gen = async function *g() { void \u0061wait; };`, options: { module: true } },
    { code: String.raw`var gen = async function *g() { void \u0061wait; };`, options: { module: true } },
    { code: String.raw`\u0061sync function* f(){}`, options: { module: true } },
    { code: String.raw`class l\u0065t {}`, options: { module: true } },
    { code: String.raw`class yi\u0065ld {}`, options: { module: true } },
    { code: String.raw`class l\u0065t {}`, options: { impliedStrict: true } },
    { code: String.raw`class yi\u0065ld {}`, options: { impliedStrict: true } },
    String.raw`class l\u0065t {}`,
    String.raw`class yi\u0065ld {}`,
    String.raw`class C { st\u0061tic m() {} }`,
    { code: String.raw`var C = class aw\u0061it {};`, options: { module: true } },
