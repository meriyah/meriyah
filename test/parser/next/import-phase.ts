...
pass('Import Phase with lexical tracking', [
...
pass('Import Phase without lexical tracking', [
...
pass('Import Phase contextual identifiers', [
...
fail('Import Phase invalid forms', [
  { code: 'import defer x from "m";', options: enableImportDefer },
