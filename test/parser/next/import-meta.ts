...
describe('Next - Import Meta', () => {
  ...
  fail('Expressions - Import Meta (fail)', [
    'import?.meta',
    { code: 'import?.meta', options: { sourceType: 'module' } },
    { code: '(import?.meta)', options: { sourceType: 'module' } },
    { code: '(import.meta([1 = ()](x = 123)))', options: { sourceType: 'module' } },
    { code: 'import.(meta([0](x = 123)))', options: { sourceType: 'module' } },
    { code: 'import.meta[0]() = 123', options: { sourceType: 'module' } },
    { code: '[import.meta] = [];', options: { sourceType: 'module' } },
    { code: '[...import.meta] = [];', options: { sourceType: 'module' } },
    { code: 'import.meta = 0;', options: { sourceType: 'module' } },
    {
      code: 'async function* f() { for await (import.meta of null) ; }',
      options: { sourceType: 'module' },
    },
    { code: 'for (import.meta in null) ;', options: { sourceType: 'module' } },
    { code: 'for (import.meta of null) ;', options: { sourceType: 'module' } },
    { code: '({a: import.meta} = {});', options: { sourceType: 'module' } },
    { code: '({...import.meta} = {});', options: { sourceType: 'module' } },
    { code: 'import.meta++;', options: { sourceType: 'module' } },
    { code: 'var x, y, z; ( { import.meta } = {});', options: { sourceType: 'module' } },
    { code: 'var x, y, z; ( { x: import.meta } = {});', options: { sourceType: 'module' } },
    { code: 'var x, y, z; ( { x: import.meta = 1 } = {});', options: { sourceType: 'module' } },
    { code: 'var x, y, z; ( [import.meta] = {});', options: { sourceType: 'module' } },
    { code: 'var x, y, z; ( [import.meta = 1] = {});', options: { sourceType: 'module' } },
    {
    ...
    { code: 'var import.meta', options: { sourceType: 'module' } },
    { code: String.raw`import.m\u0065ta;`, options: { sourceType: 'module' } },
    { code: String.raw`import.\u006deta;`, options: { sourceType: 'module' } },
  ...
  pass('Next - Import Meta (pass)', [
    ...
    { code: 'import.meta[0]', options: { sourceType: 'module' } },
    { code: 'do { import.meta } while (0)', options: { sourceType: 'module' } },
    { code: 'import.meta()', options: { sourceType: 'module' } },
    { code: 't = [...import.meta]', options: { sourceType: 'module' } },
    { code: '"use strict"; ({m() { while (0) { import.meta } }})', options: { sourceType: 'module' } },
    { code: 'delete import.meta', options: { sourceType: 'module' } },
    { code: "import.meta.resolve('something')", options: { sourceType: 'module' } },
    {
      code: 'const size = import.meta.scriptElement.dataset.size || 300;',
      options: { sourceType: 'module' },
    },
    { code: 'x = import.meta', options: { sourceType: 'module' } },
    { code: '() => { import.meta }', options: { sourceType: 'module' } },
