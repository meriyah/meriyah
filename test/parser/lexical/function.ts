...
describe('Lexical - Function', () => {
  fail('Lexical - Function (fail)', [
    ...
    { code: 'function foo([x, x]) {}', options: { module: true, lexical: true } },
    { code: 'function foo([x], [x]) {}', options: { module: true, lexical: true } },
    { code: 'function foo([x], {x:x}) {}', options: { module: true, lexical: true } },
    { code: 'function foo([x], x) {}', options: { lexical: true } },
    { code: 'function foo(x, [x]) {}', options: { lexical: true } },
    ...
    { code: 'function f(x = 0, x) {}', options: { module: true, lexical: true } },
    { code: '0, function(x = 0, x) {};', options: { module: true, lexical: true } },
    { code: 'function foo(a, a = b) {}', options: { module: true, lexical: true } },
    ...
    { code: 'function f(...a = x,){}', options: { lexical: true } },
    { code: 'function f(...a,){}', options: { lexical: true } },
    { code: 'function f(...a,){}', options: { module: true, lexical: true } },
    { code: 'function f(...a = x,){}', options: { module: true, lexical: true } },
    { code: 'function f(...a = x,){}', options: { module: true, lexical: true } },
    { code: 'function f(...a,){}', options: { module: true, lexical: true } },
    { code: 'function f(...a = x,){}', options: { lexical: true } },
    ...
    { code: 'function foo(bar, bar){}', options: { module: true, lexical: true } },
    { code: 'function f(x) { let x }', options: { lexical: true } },
