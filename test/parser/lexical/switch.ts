...
describe('Lexical - Switch', () => {
  fail('Lexical - Switch (fail)', [
    ...
    { code: 'switch (0) { case 1: async function* f() {} default: let f; }', options: { module: true, lexical: true } },
    { code: 'switch (0) { case 1: class f {} default: let f; }', options: { module: true, lexical: true } },
    { code: 'switch (0) { case 1: class f {} default: var f; }', options: { module: true, lexical: true } },
    { code: 'switch (0) { case 1: function f() {} default: const f = 0; }', options: { module: true, lexical: true } },
    { code: 'switch (0) { case 1: function f() {} default: let f; }', options: { module: true, lexical: true } },
    { code: 'switch (0) { case 1: async function* f() {} default: let f; }', options: { lexical: true } },
    ...
    { code: 'switch (0) { case 1: function f() {} default: var f }', options: { lexical: true } },
    { code: 'switch(0) { case 0: let a; default: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { default: let a; case 0: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { case 0: let a; case 1: var a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { case 0: let a; default: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { default: let a; case 0: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { case 0: let a; case 1: var a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { case 0: var a; case 1: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { case 0: var a; default: let a; }', options: { module: true, lexical: true } },
    { code: 'switch(0) { default: let a; case 0: var a; }', options: { module: true, lexical: true } },
