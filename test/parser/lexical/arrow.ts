...
describe('Lexical - Arrows', () => {
  fail('Lexical - Arrows (fail)', [
    ...
    { code: 'a => const {a}', options: { module: true, lexical: true } },
    { code: 'a => let {a}', options: { module: true, lexical: true } },
    { code: 'async a => let {a}', options: { module: true, lexical: true } },
    { code: 'yield => let yield', options: { module: true, lexical: true } },
    { code: 'a => { let a }', options: { module: true, next: true, lexical: true } },
    { code: 'a => { const a }', options: { module: true, lexical: true } },
    ...
    { code: '({y: x}, ...x) => 1;', options: { module: true, lexical: true } },
    { code: 'a = b => { let b; }', options: { module: true, lexical: true } },
    { code: '(a = b => { let b; })', options: { module: true, lexical: true } },
    { code: 'yield => { let yield; }', options: { impliedStrict: true, lexical: true } },
    { code: '({x: x, x: x}) => a', options: { module: true, lexical: true } },
    ...
    { code: '(b, a, b, a, [x]) => {}', options: { lexical: true } },
    { code: '([a,b,c]) => { const c = x; }', options: { lexical: true } },
    { code: '(b, a, b, a = x) => {}', options: { module: true, lexical: true } },
    { code: '(b, a, b, a, [x]) => {}', options: { module: true, lexical: true } },
    { code: '([a,b,c]) => { const c = x; }', options: { module: true, lexical: true } },
    { code: '(x) => { const x = y }', options: { lexical: true } },
    { code: '(x) => { let x }', options: { lexical: true } },
  ]);
