...
describe('Lexical - Lexical', () => {
  ...
  fail('Lexical - Lexical (fail)', [
    ...
    { code: 'let x; { var x }', options: { module: true, lexical: true } },
    { code: 'var x; let x;', options: { module: true, lexical: true } },
    { code: 'let x; { var x }', options: { module: true, lexical: true } },
    { code: '{ var x } let x;', options: { lexical: true } },
    ...
    { code: 'let a; export function a(){};', options: { module: true, lexical: true } },
    ...
    { code: 'let x, {x} = obj', options: { lexical: true } },
    { code: 'let x, {a: x} = obj', options: { lexical: true } },
    { code: 'let {a: x, ...{x}} = obj', options: { module: true, lexical: true } },
    { code: 'let {a: x, ...x} = obj', options: { module: true, lexical: true } },
    { code: 'let x, {x} = obj', options: { module: true, lexical: true } },
    { code: 'let x, {a: x} = obj', options: { module: true, lexical: true } },
    ...
    { code: 'const a = b; const a = c', options: { module: true, lexical: true } },
