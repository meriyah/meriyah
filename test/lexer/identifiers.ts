...
describe('Lexer - Identifiers', () => {
  ...
  fail(String.raw`fails on abc\u0Xvwxyz`, String.raw`abc\u0Xvwxyz`, Context.None);
  fail(String.raw`fails on abc\uXvwxyz`, String.raw`abc\uXvwxyz`, Context.None);
  fail('fails on `abc\\Xvwxyz', '`abc\\Xvwxyz', Context.None);
  fail(String.raw`fails on \u00`, String.raw`\u00`, Context.None);
  fail(String.raw`fails on \u007`, String.raw`\u007`, Context.None);
  fail(String.raw`fails on \u007Xvwxyz`, String.raw`\u007Xvwxyz`, Context.None);
  fail(String.raw`fails on abc\u{}`, String.raw`abc\u{}`, Context.None);
