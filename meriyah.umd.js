(function (global, factory) {
  ...
  function parseExpression(parser, context, canAssign, isPattern, inGroup, start, line, column) {
      let expr = parsePrimaryExpressionExtended(parser, context, 2, 0, canAssign, isPattern, inGroup, start, line, column);
  ...
  function parseAsyncExpression(parser, context, inGroup, canAssign, isPattern, inNew, start, line, column) {
      const { token } = parser;
  ...
  function parseLeftHandSideExpression(parser, context, canAssign, inGroup, start, line, column) {
      const expression = parsePrimaryExpressionExtended(parser, context, 2, 0, canAssign, 0, inGroup, start, line, column);
  ...
  function parseUpdateExpressionPrefixed(parser, context, inNew, start, line, column) {
      if (inNew)
          report(parser, 53);
      const { token } = parser;
      nextToken(parser, context | 32768);
  ...
  function parsePrimaryExpressionExtended(parser, context, kind, inNew, canAssign, isPattern, inGroup, start, line, column) {
      if ((parser.token & 143360) === 143360) {
          switch (parser.token) {
              case 209005:
      ...
      switch (parser.token) {
          case 33619995:
          case 33619996:
              return parseUpdateExpressionPrefixed(parser, context, inNew, start, line, column);
          case 16863275:
          case 16842797:
          case 16842798:
          case 25233967:
      ...
      while (parser.token !== 20) {
          if (consumeOpt(parser, context | 32768, 1073741842)) {
              ...
              if (token & 143360) {
                  ...
                  left = parseSpreadElement(parser, context, scope, 20, kind, origin, 0, inGroup, isPattern, tokenPos, linePos, colPos);
                  destructible |= parser.destructible;
                  if (parser.token !== 1073741842 && parser.token !== 20)
                      report(parser, 28, KeywordDescTable[parser.token & 255]);
              }
  ...
  function parseSpreadElement(parser, context, scope, closingToken, kind, origin, isAsync, inGroup, isPattern, start, line, column) {
      nextToken(parser, context | 32768);
      let argument = null;
      let destructible = 0;
      let { token, tokenValue, tokenPos, linePos, colPos } = parser;
  ...
  function parseObjectLiteralOrPattern(parser, context, scope, skipInitializer, inGroup, isPattern, kind, origin, start, line, column) {
      ...
      while (parser.token !== 1074790415) {
          ...
          if (token === 14) {
              properties.push(parseSpreadElement(parser, context, scope, 1074790415, kind, origin, 0, inGroup, isPattern, tokenPos, linePos, colPos));
          }
          else {
              let state = 0;
              let key = null;
      ...
      while (parser.token !== 1073741842) {
          ...
          if (parser.token & 143360) {
              ...
              if (parser.token === 2162700) {
                  ...
                  left = parseSpreadElement(parser, context, scope, 16, type, 0, 0, inGroup, 1, tokenPos, linePos, colPos);
              }
              parser.flags |= 128;
  ...
  function parseParenthesizedExpression(parser, context, canAssign, kind, origin, start, line, column) {
      ...
      while (parser.token !== 16) {
          ...
          if (token & (143360 | 4096)) {
              ...
              expr = parseSpreadElement(parser, context, scope, 16, kind, origin, 0, 1, 0, tokenPos, linePos, colPos);
      ...
      while (parser.token !== 1073741842) {
          ...
          if (parser.token & 143360) {
              ...
              if (parser.token === 2162700) {
                  ...
                  left = parseSpreadElement(parser, context, scope, 16, kind, 0, 0, inGroup, 1, tokenPos, linePos, colPos);
              }
              else {
                  report(parser, 28, KeywordDescTable[parser.token & 255]);
              }
  ...
  function parseAsyncArrowOrCallExpression(parser, context, callee, canAssign, kind, origin, flags, start, line, column) {
      ...
      while (parser.token !== 16) {
          ...
          if (token & (143360 | 4096)) {
              ...
              expr = parseSpreadElement(parser, context, scope, 16, kind, origin, 1, 1, 0, tokenPos, linePos, colPos);
