...
export declare function parseYieldExpression(parser: ParserState, context: Context, start: number, line: number, column: number): ESTree.YieldExpression;
export declare function parseAwaitExpression(parser: ParserState, context: Context, inNewExpression: 0 | 1, start: number, line: number, column: number): ESTree.IdentifierOrExpression | ESTree.AwaitExpression;
...
export declare function parseUpdateExpression(parser: ParserState, context: Context, inNewExpression: 0 | 1, start: number, line: number, column: number): ESTree.UpdateExpression;
...
export declare function parseParenthesizedExpression(parser: ParserState, context: Context, assignable: 0 | 1, kind: BindingKind, origin: Origin, start: number, line: number, column: number): any;
