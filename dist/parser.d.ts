...
export declare function parseExpressions(parser: ParserState, context: Context, inGroup: 0 | 1, allowAssign: 0 | 1, start: number, line: number, column: number): ESTree.SequenceExpression | ESTree.Expression;
export declare function parseAssignmentExpression(parser: ParserState, context: Context, inGroup: 0 | 1, start: number, line: number, column: number, left: ESTree.ArgumentExpression | ESTree.Expression): ESTree.ArgumentExpression | ESTree.Expression;
...
export declare function parseAsyncExpression(parser: ParserState, context: Context, inGroup: 0 | 1, allowAssign: 0 | 1, identifierPattern: 0 | 1, inNewExpression: 0 | 1, start: number, line: number, column: number): any;
export declare function parseYieldExpression(parser: ParserState, context: Context, inGroup: 0 | 1, allowAssign: 0 | 1, start: number, line: number, column: number): ESTree.YieldExpression | ESTree.Identifier | ESTree.ArrowFunctionExpression;
export declare function parseAwaitExpression(parser: ParserState, context: Context, inNewExpression: 0 | 1, inGroup: 0 | 1, start: number, line: number, column: number): ESTree.IdentifierOrExpression | ESTree.AwaitExpression;
...
export declare function parseOptionalExpression(parser: ParserState, context: Context, expr: ESTree.Expression): ESTree.OptionalChain;
export declare function parsePropertyOrPrivatePropertyName(parser: ParserState, context: Context): any;
export declare function parseUpdateExpressionPrefixed(parser: ParserState, context: Context, inNewExpression: 0 | 1, start: number, line: number, column: number): ESTree.UpdateExpression;
...
export declare function parseTemplateSpans(parser: ParserState, context: Context, tail: boolean): ESTree.TemplateElement;
...
export declare function parseArrayExpressionOrPattern(parser: ParserState, context: Context, scope: ScopeState | undefined, skipInitializer: 0 | 1, inGroup: 0 | 1, kind: BindingKind, origin: Origin, start: number, line: number, column: number): ESTree.ArrayExpression | ESTree.ArrayPattern | ESTree.AssignmentExpression;
...
export declare function parseObjectLiteralOrPattern(parser: ParserState, context: Context, scope: ScopeState | undefined, skipInitializer: 0 | 1, inGroup: 0 | 1, kind: BindingKind, origin: Origin, start: number, line: number, column: number): ESTree.ObjectExpression | ESTree.ObjectPattern | ESTree.AssignmentExpression;
...
export declare function parseParenthesizedExpression(parser: ParserState, context: Context, allowAssign: 0 | 1, kind: BindingKind, origin: Origin, start: number, line: number, column: number): any;
...
export declare function parseAsyncArrowOrCallExpression(parser: ParserState, context: Context, callee: ESTree.Identifier | void, allowAssign: 0 | 1, kind: BindingKind, origin: Origin, flags: Flags, start: number, line: number, column: number): ESTree.CallExpression | ESTree.ArrowFunctionExpression;
