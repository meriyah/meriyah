...
export declare function parseExpression(parser: ParserState, context: Context, assignable: 0 | 1, start: number): ESTree.Expression;
...
export declare function parseBinaryExpression(parser: ParserState, context: Context, start: number, minPrec: number, left: ESTree.AssignmentExpression | ESTree.BinaryExpression | ESTree.LogicalExpression | ESTree.Identifier | ESTree.Literal | ESTree.ConditionalExpression): ESTree.AssignmentExpression | ESTree.LogicalExpression | ESTree.BinaryExpression | ESTree.Identifier | ESTree.Literal | ESTree.ConditionalExpression;
...
export declare function parseLeftHandSideExpression(parser: ParserState, context: Context, assignable: 0 | 1, start: number): any;
export declare function parseMemberOrUpdateExpression(parser: ParserState, context: Context, expr: ESTree.Expression, inNewExpression: 0 | 1, isImportCall: 0 | 1, start: number): any;
export declare function parsePrimaryExpressionExtended(parser: ParserState, context: Context, type: BindingType, inNewExpression: 0 | 1, assignable: 0 | 1, start: number): any;
...
export declare function parseTemplateTail(parser: ParserState, context: Context, _start: number): ESTree.TemplateElement;
...
export declare function parseArguments(parser: ParserState, context: Context, isImportCall: 0 | 1): (ESTree.SpreadElement | ESTree.Expression)[];
...
export declare function parseAsyncArrowOrCallExpression(parser: ParserState, context: Context, callee: ESTree.Identifier | void, assignable: 0 | 1, asyncNewLine: 0 | 1, start: number): any;
...
export declare function parseClassBody(parser: ParserState, context: Context, type: BindingType, origin: BindingOrigin): ESTree.ClassBody;
