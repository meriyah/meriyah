define(['exports'], function (exports) { 'use strict';
      ...
      if (isValidAsKeyword && (length >= 2 && length <= 11)) {
          ...
          return token === void 0
              ...
              : token === 241770 || !hasEscape
                  ? token
                  : context & 1024 && (token === 241736 || token === 36969)
                      ? 143479
                      : (token & 36864) === 36864
                          ? context & 1024
                              ? 143479
  ...
  function classifyIdentifier(parser, context, t, isArrow, shouldBanEscaped) {
      ...
      if (shouldBanEscaped && (t & 143478) === 143478) {
          report(parser, 96);
      }
  ...
  function parseAsyncArrowOrAsyncFunctionDeclaration(parser, context, scope, origin, labels, allowFuncDecl, start, line, column) {
      ...
      if (parser.token === 67174411) {
          ...
          if (parser.token === 10) {
              classifyIdentifier(parser, context, token, 1, 1);
