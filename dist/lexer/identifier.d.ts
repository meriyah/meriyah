...
export declare function scanIdentifierSlowCase(parser: ParserState, context: Context, hasEscape: number, canBeKeyword: number): Token;
export declare function scanPrivateName(parser: ParserState): Token;
export declare function scanIdentifierUnicodeEscape(parser: ParserState): number | void;
